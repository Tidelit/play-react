"use client";
import { FiChevronLeft, FiEdit2, FiEye } from "react-icons/fi";
        ...
        <div className="w-full h-full flex flex-col justify-center items-center">
            ...
            <div className="w-full h-14 flex flex-row justify-between items-center p-10">
                        ...
                        <div className="w-auto flex flex-row gap-2">
                            <Link href="/options" className="w-auto hover:text-blue-500 transition-colors duration-500 cursor-pointer flex flex-row items-center gap-2">
                        ...
                        <div className="w-full h-full flex flex-col items-center gap-2 p-10">
                            ...
                            <div className="w-full h-24 border flex flex-row items-center justify-between p-4 bg-blue-800/40 text-white">
                                <div className="flex flex-row items-center gap-4">
                                    <p>1</p>
                                    <button className="w-20 h-20 rounded-full bg-white"></button>
