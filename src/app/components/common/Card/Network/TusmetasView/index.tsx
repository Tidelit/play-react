    ...
    return (
        <>
            <div className="w-full h-full flex flex-col justify-center items-center p-10">
                ...
                {/* Métricas Generales */}
                <div className="w-full h-full rounded-2xl flex flex-col gap-2 p-10">
                ...
                <div className="w-full flex flex-col gap-4 p-10">
                    {/* Texto */}
                    <div className="w-full h-auto  flex flex-col justify-center items-start">
                        <p className="text-xs">Mira tus referidos</p>
                        <h1 className="text-2xl font-bold uppercase">Tu lista de referidos</h1>
                    </div>
                    <TusReferidos />
                    <TusReferidos />
                    <TusReferidos />
